...
- [load_from_tree](https://github.com/toophy/behavior3go/tree/master/examples/load_from_tree)  ：从导出的树文件加载示例
- [load_from_project](https://github.com/toophy/behavior3go/tree/master/examples/load_from_project) ：从导出的工程文件加载示例
- [load_from_rawproject](https://github.com/toophy/behavior3go/tree/master/examples/load_from_rawproject) ：从原生工程文件加载示例
- [subtree](https://github.com/toophy/behavior3go/tree/master/examples/subtree) ：子树的使用示例（需要[专用的编辑器分支版本](https://github.com/magicsea/behavior3editor)）
...
![image](https://github.com/toophy/behavior3go/blob/master/b3_simple1.png)
...
```
- Q:如何设计打断一个进行中的状态？   
A:参考https://github.com/toophy/behavior3go/issues/15
## TODO
- [ ] 参数类型化
- [ ] 参数支持传递黑板值利用格式“@变量名”
- [ ] 子树支持自定义参数传递
